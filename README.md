# Enclst
## What is this?
The Enclst is a notation rule and API **for humans** to write a list structure **concisely** compared to **JSON**, which has the pitfalls of being prone to write **illegal syntax**.
